...
struct QuizBrain {
    ...
    let quiz = [
        ...
        Quiz(q: "When a function takes a closure as a parameter, when do you want to mark it as escaping?", co: nil, ch: [Choices(one: "when it's executed after the function returns", two: "when it's scope is undefined", three: "when it's lazy loaded", four: "all of these answers")], a: <#T##String#>),
        Quiz(q: "What's wrong with this code?", co: "class Person {\nvar name: String\nvar address: String\n}", ch: [Choices(one: "Person has no initializers.", two: "Person has no base class.", three: "var name is not formatted correctly.", four: "address is a keyword.")], a: <#T##String#>),
        Quiz(q: "What is the value of names after this code is executed?", co: "let names = [“Bear“, “Joe“, “Clark“]\nnames.map { (s) -> String in\nreturn s.uppercased()\n}", ch: [Choices(one: "[“BEAR“, “JOE“, “CLARK“]", two: "[“B“, “J“, “C“]", three: "[“Bear“, “Joe“, “Clark“]", four: "This code contains an error.")], a: <#T##String#>),
        
//        Quiz(q: "What describes this line of code?", co: ???, ch: [Choices(one: "a constant named val of type Int", two: "a variable named val of type item", three: "a constant named val of type Number", four: "a variable named val of type Int")], a: ??),
        
        
        Quiz(q: "didSet and willSet are examples of _?", co: nil, ch: [Choices(one: "property observers", two: "key properties", three: "all of these answers", four: "newOld value calls")], a: <#T##String#>),
        Quiz(q: "What is wrong with this code?", co: "self.callback = {\n self.attempts += 1\nself.downloadFailed()\n}", ch: [Choices(one: "Use of self inside the closure causes retain cycle.", two: "You cannot assign a value to closure in this manner.", three: "You need to define the type of closure explicitly.", four: "There is nothing wrong with this code.")], a: <#T##String#>),
        Quiz(q: "How many values does vals have after this code is executed?", co: "var vals = Set<String> = [“4“, “5“, “6“]\nvals.insert(“5“)", ch: [Choices(one: "three", two: "four", three: "eight", four: "This code contains an error")], a: <#T##String#>),
        Quiz(q: "How can you avoid a strong reference cycle in a closure?", co: nil, ch: [Choices(one: "Use a capture list to set class instances of weak or unowned.", two: "You can't, there will always be a danger of strong reference cycles inside a closure.", three: "Initialize the closure as read-only.", four: "Declare the closure variable as lazy.")], a: <#T##String#>),
        Quiz(q: "What is wrong with this code?", co: "if let s = String.init(“some string“) {\n print(s)\n}", ch: [Choices(one: "This String initializer does not return an optional.", two: "String does not have an initializer that can take a String.", three: "= is not a comparison.", four: "Nothing is wrong with this code.")], a: <#T##String#>),
        Quiz(q: "Which code snippet correctly creates a typealias closure?", co: nil, ch: [Choices(one: "typealias CustomClosure: () -> ()", two: "typealias CustomClosure { () -> () }", three: "typealias CustomClosure -> () -> ()", four: "typealias CustomClosure -> () {}")], a: <#T##String#>),
        Quiz(q: "How do you reference class members from within a class?", co: nil, ch: [Choices(one: "self", two: "instance", three: "class", four: "this")], a: <#T##String#>),
        Quiz(q: "All value types in Swift are _ under the hood?", co: nil, ch: [Choices(one: "structs", two: "classes", three: "optionals", four: "generics")], a: <#T##String#>),
        Quiz(q: "How many times will this loop be executed?", co: "for i in 0...100 {\n print(i)\n}", ch: [Choices(one: "0", two: "101", three: "99", four: "100")], a: <#T##String#>),
        Quiz(q: "What can AnyObject represent?", co: nil, ch: [Choices(one: "an instance of any class", two: "an instance of function type", three: "all of these answers", four: "an instance of an optional type")], a: <#T##String#>),
